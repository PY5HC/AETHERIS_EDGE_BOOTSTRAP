...
for needle in 'PY5HC/AETHERIS_NODE_AGENT' '4469fbad1f020d3c0bc82c986418c0aab0caf692' 'PY5HC/AETHERIS_GOVERNANCE' 'ff1318cd8f0a9720f66029e3985d1e5854044128' 'NOT_YET_ESTABLISHED' 'CURRENT_V1=DIRECTORY' 'FUTURE_MODEL=SYMLINK' 'MIGRATION_REQUIRED=YES' '/opt/aetheris/releases/<release-id>' 'artifact hash' 'readiness' 'rollback'; do grep -Fqi "$needle" "$DOC" || fail "doc $needle"; done
